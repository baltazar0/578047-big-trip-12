...
const createDayEventsListTemplate = () => {
  return (
...
render(tripMainElement, createTtipInfoTemplate(), `afterbegin`);
...
render(tripControlsTitleElement, createTripTabsTemplate(), `afterend`);
